...
class BrowserTab(QWidget):
    ...
    def __init__(self, parent=None, url="file:///C:/Users/DELL/Documents/Hackathons/raptors_dei_accessible_hack/VoxSurf/index.html"):
        super().__init__()
            ...
            try:
                if match:
                    ...
                    (function() {{
                        ...
                        const elementsVoxSurf = document.querySelectorAll('*');
                        elementsVoxSurf.forEach((element) => {{
                            const rect = element.getBoundingClientRect();
                            if (
                                rect.top < boundaryBoxVoxSurf.bottom &&
                                rect.bottom > boundaryBoxVoxSurf.top &&
                                rect.left < boundaryBoxVoxSurf.right &&
                                rect.right > boundaryBoxVoxSurf.left
                            ) {{
...
class Browser(QMainWindow):
    def __init__(self):
        ...
        self.downloads_dir = os.path.join(
            os.path.expanduser("~"), "Downloads", "VoxSurf"
        )
...
class AudioRecorder(QObject):
    ...
    def stop_recording(self):
        ...
        transcription_output = run_groq_stt("output.wav") # os.path.dirname(__file__) + 
